...
## Люди
- @Eric-Lebedenko — владелец, основные фичи/баги, ревью.
- @VladLitvinov — QA (ревью/тесты, мелкие правки).
- @tiktak6828 — дополнительный dev, только безопасные задачи/документация, без мержа без ревью.
